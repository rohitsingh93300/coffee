  ...
  return (
    <div id='contact' style={bgImage} className="min-h-screen bg-coffee-light text-coffee-dark flex items-center justify-center p-6">
      ...
      className="w-full max-w-3xl bg-amber-900/20 rounded-lg shadow-md p-8 ">
        <h1 className="text-3xl font-bold text-center text-amber-900 mb-6 font-cursive">Contact Us</h1>
        ...
        <form className="space-y-6">
          ...
          <button
            ...
            className="w-full py-2 px-4 bg-amber-900 text-white font-semibold rounded-lg shadow-md hover:bg-coffee-dark transition duration-300"
          >
            Send Message
          </button>
        </form>
        ...
        <div className="mt-8 text-center">
          ...
          <p className="font-semibold text-coffee-primary">info@coffeewebsite.com</p>
        </div>
      </motion.div>
    </div>
  )
